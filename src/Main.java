...
public class Main {
    ...
    private static final String IS_EQUAL = "EP";
    ...
    private static void EqualContacts(ContactBook cBook){
        if (cBook.hasEqualContacts()){ System.out.println(CONTACT_EQUALS);}
        
        else{ System.out.println(CONTACT_NOT_EQUALS);}
    }
}
